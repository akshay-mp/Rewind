...
import { MarkdownPreview } from "@/lib/timetravel/markdown";
import { streamTimeTravel } from "@/lib/timetravel/stream-client";
...
export function SpanDetail() {
  ...
  async function runBranch() {
    const s = useTimeTravelStore.getState();
    ...
    await streamTimeTravel(
      "/api/timetravel/branch",
      {
        parent,
