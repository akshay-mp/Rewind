"""Derive Rewind ``SpanKind`` from raw GenAI semconv attributes.

The classifier is the seam where Rewind maps OpenInference / OTel GenAI
...
def classify_span(span_name: str, attributes: dict[str, Any]) -> SpanKind:
    """Map a raw OTel span onto a Rewind ``SpanKind``.
