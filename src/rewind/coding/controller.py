...
class CodingController:
    ...
    def rewind(self, run_id: str, sequence: int) -> list[CodingEvent]:
        """View-only rewind convenience method."""
        return self.navigate(run_id, "rewind", sequence)
