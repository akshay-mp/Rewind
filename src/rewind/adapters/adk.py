    ...
    *,
    ...
    class _ReplayLlm(BaseLlm):  # type: ignore[misc]
        ...
        def _get_model_name(self) -> str:
            return str(getattr(self._rewind_wrapped, "model", "adk-replay"))
        ...
        async def _dispatch_async(
            ...
            if recorded is None:
                assert_not_frozen(session)
                result = await self._rewind_wrapped.generate_response_async(request)
        ...
        def generate_response(
            ...
            if recorded is None:
                assert_not_frozen(session)
                result = self._rewind_wrapped.generate_response(request)
                self._capture_live_span(request, session, result,
                                        self._get_model_name())
                return result
            return self._materialise(recorded)
        ...
        def _signature(self, request: Any) -> Any:
            ...
            # openai_intercept because Rewind treats any (model, messages,
