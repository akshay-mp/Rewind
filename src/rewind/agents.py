...
caller that validates inputs, injects :class:`RewindContext`, and installs
...
_PLUGINS: dict[str, FrameworkPlugin] = {
    ...
    "crewai": FrameworkPlugin(
        ...
        "rewind.adapters.crewai.replay_llm",
    ...
    "pydantic_ai": FrameworkPlugin(
        ...
        ("pydantic_ai",),
        {"interactive_llm": False, "native_tool_calls": False, "python_tools": True},
        "rewind.adapters.pydantic_ai.replay_model",
        workbench_supported=False,
        unsupported_reason=(
    ...
    "adk": FrameworkPlugin(
        ...
        ("google.adk",),
        {"interactive_llm": False, "native_tool_calls": False, "python_tools": True},
        "rewind.adapters.adk.replay_llm",
        workbench_supported=False,
        unsupported_reason=(
    ...
    "smolagents": FrameworkPlugin(
        ...
        ("smolagents",),
        {"interactive_llm": False, "native_tool_calls": False, "python_tools": True},
        "rewind.adapters.smolagents.replay_model",
        workbench_supported=False,
        unsupported_reason=(
...
def _build_input_model(func: Callable[..., Any]) -> tuple[type[BaseModel], bool]:
    ...
    for parameter in inspect.signature(func).parameters.values():
        if parameter.kind in (parameter.VAR_POSITIONAL, parameter.VAR_KEYWORD):
            raise TypeError("rewind.agent functions cannot use *args or **kwargs")
...
class Rewind:
    ...
    def __init__(self, title: str = "Rewind") -> None:
        self.title = title
        ...
        *,
        ...
        def decorate(func: Callable[..., Any]) -> Callable[..., Any]:
            ...
            if ref in self._agents:
                raise ValueError(f"duplicate agent name/ref {ref!r} on this Rewind instance")
            ...
            func.__rewind_agent__ = definition  # type: ignore[attr-defined]
            return func
